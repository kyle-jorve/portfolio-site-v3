(this.wordgame = this.wordgame || {}),
	(this.wordgame.bundle = (function (e) {
		'use strict';
		function a(e) {
			return (a =
						...
						value: function () {
							...
							this.shadowRoot.appendChild(Sa.content.cloneNode(!0)),
								(this.shadowRoot.querySelector('#hash').textContent =
									null === (e = window.wordgame) || void 0 === e ? void 0 : e.hash),
		...
		Ca('config', 'G-2SSGMHY3NP', {
			app_version: null === (Ea = window.wordgame) || void 0 === Ea ? void 0 : Ea.hash,
			debug_mode: !1
		});
		var La = [
				'cigar',
