export const globalData = {
	logo: '/dist/media/icons/logo-circle-icon.svg',
	logoIcon: '/dist/media/icons/logo-circle.svg',
	email: 'kyle@kylejorve.com',
	...
	nav: [
		...
		},
		{
			pageName: 'CV',
			url: '/cv/',
			icon: '/dist/media/icons/cv-icon.svg',
			alt: 'Icon for Bio page',
			showInMobileNav: true
		},
		{
			pageName: 'Shop',
			...
			icon: '/dist/media/icons/cart-icon.svg',
			alt: 'Icon for shop page',
			cssClass: 'mobileNav__item--shop',
			showInMobileNav: true
		}
	],
	socialIcons: {
		standard: [
			{ name: 'artstation', url: 'https://www.artstation.com/kylejorve' },
			{ name: 'facebook', url: 'https://www.facebook.com/kyle.jorve.art' },
			{ name: 'instagram', url: 'https://www.instagram.com/kylejorve/' },
			{ name: 'tumblr', url: 'https://kylejorve.tumblr.com/' },
			{ name: 'linkedin', url: 'http://www.linkedin.com/in/kyle-jorve' }
		],
		commerce: [
			{ name: 'patreon', url: 'https://www.patreon.com/kylejorve' },
			{ name: 'inprnt', cssClass: 'shopping-cart', url: 'https://www.inprnt.com/gallery/kylejorve/' },
			{
				name: 'gumroad',
	...
	copyright: `<p>&copy; Copyright 2018-[[year]] Kyle Jorve. All rights reserved.<br>Website designed and built by Kyle Jorve.</p>`
};
