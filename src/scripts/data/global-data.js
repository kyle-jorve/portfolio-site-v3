export const globalData = {
	get logo() {
		return '/dist/media/icons/logo-circle-icon.svg';
	},
	get logoIcon() {
		return '/dist/media/icons/logo-circle.svg';
	},
	get email() {
	...
	get copyright() {
		return `<p>&copy; Copyright 2018-[[year]] Kyle Jorve. All rights reserved.<br>Website designed and built by Kyle Jorve.</p>`;
	}
};
