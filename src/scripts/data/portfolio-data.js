	...
	items: [
		{
			...
			media: [
				...
				{
					sources: [
						{ url: '/dist/media/portfolio/cargha/final/kyle-jorve_cargha-1920.jpg', minScreenSize: 1440 },
						{ url: '/dist/media/portfolio/cargha/final/kyle-jorve_cargha-1440.jpg', minScreenSize: 1024 },
		...
		},
		{
			...
			thumbnail: {
				...
				alt:
					'Tyene, a half-elf ranger, stands in the middle of a forest, a pond at her back, looking at and reaching up toward a pixie',
				mediaIndex: 0
			},
			featuredThumbnail: {
				sources: [
			...
			detailThumbnail: {
				sources: [{ url: '/dist/media/portfolio/tyene/final/kyle-jorve_tyene-480.jpg', minScreenSize: 640 }],
			...
			media: [
				...
				},
				{
					sources: [
						...
						{ url: '/dist/media/portfolio/tyene/wip-1/kyle-jorve_tyene-wip-1-1024.jpg', minScreenSize: 640 }
					],
				...
				},
				{
					sources: [
						...
						{ url: '/dist/media/portfolio/tyene/wip-2/kyle-jorve_tyene-wip-2-1024.jpg', minScreenSize: 640 }
					],
				...
				},
				{
					sources: [
						...
						{ url: '/dist/media/portfolio/tyene/wip-3/kyle-jorve_tyene-wip-3-1024.jpg', minScreenSize: 640 }
					],
				...
				},
				{
					sources: [
						...
						{ url: '/dist/media/portfolio/tyene/wip-4/kyle-jorve_tyene-wip-4-1024.jpg', minScreenSize: 640 }
					],
				...
				},
				{
					sources: [
						...
						{ url: '/dist/media/portfolio/tyene/wip-5/kyle-jorve_tyene-wip-5-1024.jpg', minScreenSize: 640 }
					],
				...
				},
				{
					sources: [
						...
						{ url: '/dist/media/portfolio/tyene/wip-6/kyle-jorve_tyene-wip-6-1024.jpg', minScreenSize: 640 }
					],
		...
		},
		{
			...
			thumbnail: {
				sources: [
					{
						url:
							'/dist/media/portfolio/pendrakes-chamber/detail-1/kyle-jorve_pendrakes-chamber-detail-1-480.jpg',
						minScreenSize: 1024
					},
					{
						url:
							'/dist/media/portfolio/pendrakes-chamber/detail-1/kyle-jorve_pendrakes-chamber-detail-1-512.jpg',
						minScreenSize: 640
					}
				],
				mobileSource:
			...
			media: [
				{
					...
					mobileSource: '/dist/media/portfolio/pendrakes-chamber/final/kyle-jorve_pendrakes-chamber-640.jpg',
				...
				},
				{
					sources: [
						{
							url:
								'/dist/media/portfolio/pendrakes-chamber/detail-1/kyle-jorve_pendrakes-chamber-detail-1-1920.jpg',
							minScreenSize: 1440
						},
						{
							url:
								'/dist/media/portfolio/pendrakes-chamber/detail-1/kyle-jorve_pendrakes-chamber-detail-1-1440.jpg',
							minScreenSize: 1024
						},
						{
							url:
								'/dist/media/portfolio/pendrakes-chamber/detail-1/kyle-jorve_pendrakes-chamber-detail-1-1024.jpg',
							minScreenSize: 640
						}
					],
					mobileSource:
				...
				},
				{
					sources: [
						{
							url:
								'/dist/media/portfolio/pendrakes-chamber/detail-2/kyle-jorve_pendrakes-chamber-detail-2-1920.jpg',
							minScreenSize: 1440
						},
						{
							url:
								'/dist/media/portfolio/pendrakes-chamber/detail-2/kyle-jorve_pendrakes-chamber-detail-2-1440.jpg',
							minScreenSize: 1024
						},
						{
							url:
								'/dist/media/portfolio/pendrakes-chamber/detail-2/kyle-jorve_pendrakes-chamber-detail-2-1024.jpg',
							minScreenSize: 640
						}
					],
					mobileSource:
				...
				},
				{
					sources: [
						{
							url:
								'/dist/media/portfolio/pendrakes-chamber/detail-3/kyle-jorve_pendrakes-chamber-detail-3-1920.jpg',
							minScreenSize: 1440
						},
						{
							url:
								'/dist/media/portfolio/pendrakes-chamber/detail-3/kyle-jorve_pendrakes-chamber-detail-3-1440.jpg',
							minScreenSize: 1024
						},
						{
							url:
								'/dist/media/portfolio/pendrakes-chamber/detail-3/kyle-jorve_pendrakes-chamber-detail-3-1024.jpg',
							minScreenSize: 640
						}
					],
					mobileSource:
				...
				},
				{
					sources: [
						{
							url:
								'/dist/media/portfolio/pendrakes-chamber/detail-4/kyle-jorve_pendrakes-chamber-detail-4-1920.jpg',
							minScreenSize: 1440
						},
						{
							url:
								'/dist/media/portfolio/pendrakes-chamber/detail-4/kyle-jorve_pendrakes-chamber-detail-4-1440.jpg',
							minScreenSize: 1024
						},
						{
							url:
								'/dist/media/portfolio/pendrakes-chamber/detail-4/kyle-jorve_pendrakes-chamber-detail-4-1024.jpg',
							minScreenSize: 640
						}
					],
					mobileSource:
				...
				},
				{
					sources: [
						{
							url:
								'/dist/media/portfolio/pendrakes-chamber/detail-5/kyle-jorve_pendrakes-chamber-detail-5-1920.jpg',
							minScreenSize: 1440
						},
						{
							url:
								'/dist/media/portfolio/pendrakes-chamber/detail-5/kyle-jorve_pendrakes-chamber-detail-5-1440.jpg',
							minScreenSize: 1024
						},
						{
							url:
								'/dist/media/portfolio/pendrakes-chamber/detail-5/kyle-jorve_pendrakes-chamber-detail-5-1024.jpg',
							minScreenSize: 640
						}
					],
					mobileSource:
					...
					alt:
						'Pendrake and Kyra doze together in bed; various props are scattered over the neighboring nighstand'
				}
			]
		},
		{
		...
		},
		{
			...
			thumbnail: {
				...
				alt:
					'an alien breathes in the thick atmoshpere of its home planet through a mouth overgrown with filtering cilia',
				mediaIndex: 0
			},
			featuredThumbnail: {
				sources: [
			...
			detailThumbnail: {
				sources: [{ url: '/dist/media/portfolio/olfactory/kyle-jorve_olfactory-480.jpg', minScreenSize: 640 }],
			...
			media: [
				{
					sources: [
						{ url: '/dist/media/portfolio/olfactory/kyle-jorve_olfactory-1920.jpg', minScreenSize: 1440 },
						{ url: '/dist/media/portfolio/olfactory/kyle-jorve_olfactory-1440.jpg', minScreenSize: 1024 },
		...
		},
		{
			...
			thumbnail: {
				...
				alt:
					'Luna stands naked beneath the symbol of the Order of the Eidolons--a dark star shedding rays of shadow over a darkened moon--crystalline growths covering his body as his extremities fade from existence',
				mediaIndex: 0
			},
			featuredThumbnail: {
				sources: [
			...
			media: [
				...
				{
					source:
						'<iframe src="https://www.youtube.com/embed/PxoZ4MjlxOY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>',
					bgIndex: 0,
					video: true
				}
			]
		},
		{
			...
			thumbnail: {
				...
				alt:
					'Crow stands before a cluster of dead ravens as more fall from the sky; the raven immediately before him is white',
				mediaIndex: 0
			},
			featuredThumbnail: {
				sources: [
		...
		},
		{
			...
			thumbnail: {
				sources: [
					{
						url:
							'/dist/media/portfolio/assembly-of-a-complex-organism/kyle-jorve_assembly-of-a-complex-organism-480.jpg',
						minScreenSize: 1024
					},
					{
						url:
							'/dist/media/portfolio/assembly-of-a-complex-organism/kyle-jorve_assembly-of-a-complex-organism-512.jpg',
						minScreenSize: 640
					}
				],
				mobileSource:
				...
				alt:
					'An abstract assembly of colors and materials, all layering over and feeding into one another, like spreading fungus',
				mediaIndex: 0
			},
			featuredThumbnail: {
				sources: [
			...
			media: [
				{
					sources: [
						{
							url:
								'/dist/media/portfolio/assembly-of-a-complex-organism/kyle-jorve_assembly-of-a-complex-organism-1920.jpg',
							minScreenSize: 1440
						},
						{
							url:
								'/dist/media/portfolio/assembly-of-a-complex-organism/kyle-jorve_assembly-of-a-complex-organism-1440.jpg',
							minScreenSize: 1024
						},
						{
							url:
								'/dist/media/portfolio/assembly-of-a-complex-organism/kyle-jorve_assembly-of-a-complex-organism-1024.jpg',
							minScreenSize: 640
						}
					],
					mobileSource:
		...
		},
		{
			...
			thumbnail: {
				sources: [
					{ url: '/dist/media/portfolio/orlandatime/kyle-jorve_orlandatime-480.jpg', minScreenSize: 1024 },
			...
			featuredThumbnail: {
				sources: [
					{ url: '/dist/media/portfolio/orlandatime/kyle-jorve_orlandatime-640.jpg', minScreenSize: 1440 },
			...
			media: [
				{
					sources: [
						...
						{ url: '/dist/media/portfolio/orlandatime/kyle-jorve_orlandatime-1024.jpg', minScreenSize: 640 }
					],
					mobileSource: '/dist/media/portfolio/orlandatime/kyle-jorve_orlandatime-640.jpg',
					alt: 'a landscape of an alien planet, bright red vegetation rolling across a sweeping, craggy hill'
				}
		...
		},
		{
			...
			thumbnail: {
				...
				alt:
					'Riku, Namine, and Roxas stand on a dark, destroyed beach on Destiny Island; fissures crack the landscape; Mickey stands hidden in the distance; the heart-shaped moon glows overhead',
				mediaIndex: 0
			},
			featuredThumbnail: {
				sources: [
